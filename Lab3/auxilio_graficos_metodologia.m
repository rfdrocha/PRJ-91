...
figure(1)
plot(velocidades,Potencia_total_subida_hp,'LineWidth',2,'Color','k');
hold on
plot(velocidades,Potencia_total_subida_nivelado_hp,'--','LineWidth',2,'Color','k');
...
legend({'Pot\^encia Total','Pot\^encia total sem corre\c{c}\~ao','Pot\^encia disponivel'},'Location','southwest',Interpreter='latex');
...
figure(2)
hold on
plot(velocidades,vs_subida_subida_kts,'LineWidth',2,'Color','k')
plot(velocidades,vs_descida_subida_kts,'LineWidth',2,'Color','k')
...
figure(3)
plot(velocidades,Potencia_total_nivelado_1_hp,'LineWidth',2,'Color','k');
hold on
...
yline(180,'LineWidth',1,'Color','k'); % potencia maxima
...
legend({'Pot\^encia Total','Pot\^encia disponivel'},'Location','southwest',Interpreter='latex');
xlabel('Velocidade (kt)',Interpreter='latex');
ylabel('Pot\^encia (hp)',Interpreter='latex');
...
figure(4)
hold on
plot(velocidades,vs_subida_nivelado_1_kts,'LineWidth',2,'Color','k')
plot(velocidades,vs_descida_nivelado_1_kts,'LineWidth',2,'Color','k')
...
figure(5)
plot(velocidades,Potencia_total_nivelado_2_hp,'LineWidth',2,'Color','k');
hold on
...
figure(6)
hold on
plot(velocidades,vs_subida_nivelado_2_kts,'LineWidth',2,'Color','k')
plot(velocidades,vs_descida_nivelado_2_kts,'LineWidth',2,'Color','k')
...
Potencia_total_sem_descida_hp = Potencias_induzidas_descida_hp + Potencia_de_perfil_descida_hp + Potencia_parasita_descida_hp + Potencia_miscelanea_descida_hp;
...
% Grafico de potencia de subida
figure(7)
plot(velocidades,Potencia_total_descida_hp,'LineWidth',2,'Color','k');
hold on
...
yline(180,'LineWidth',1,'Color','k'); % potencia maxima
plot(velocidades,Potencia_total_sem_descida_hp,'LineWidth',1,'Color','k','LineStyle','--');
...
legend({'Pot\^encia Total','Pot\^encia disponivel','Pot\^encia nivelado antes dessa raz\~ao de descida'},'Location','southwest',Interpreter='latex');
xlabel('Velocidade (kt)',Interpreter='latex');
ylabel('Pot\^encia (hp)',Interpreter='latex');
...
figure(8)
hold on
plot(velocidades,vs_subida_descida_kts,'LineWidth',2,'Color','k')
plot(velocidades,vs_descida_descida_kts,'LineWidth',2,'Color','k')
